...
def build_targets(predict_boxes, predict_cls, target, anchors, ignore_thres):
    ...
    class_mask[b, best_n, gj, gi] = (predict_cls[b, best_n, gj, gi].argmax(-1) == target_labels).float()
    iou_scores[b, best_n, gj, gi] = bbox_iou(predict_boxes[b, best_n, gj, gi], target_boxes, x1y1x2y2=False)
